		...
		<div class="tcube-footer__top">
			<div class="tcube-footer__brand">
				...
				<ul class="tcube-footer__social" aria-label="<?php esc_attr_e( 'Social links', 'thetcube' ); ?>">
					<li>
						<a class="tcube-footer__social-link tcube-footer__social-link--linkedin" href="https://www.linkedin.com/company/the-tech-sang" target="_blank" rel="noopener noreferrer nofollow" aria-label="<?php esc_attr_e( 'LinkedIn', 'thetcube' ); ?>">
